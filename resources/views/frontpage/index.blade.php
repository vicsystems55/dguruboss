            ...
            <div class="container">
                <div class="row justify-content-sm-center">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="{{url('/frontpage/assets/img/icon/icon1.svg')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="{{ url('/frontpage/assets/img/icon/icon2.svg')}}" alt="">
                            </div>
                            <div class="features-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="{{ url('/frontpage/assets/img/icon/icon3.svg')}}" alt="">
                            </div>
                            <div class="features-caption">
