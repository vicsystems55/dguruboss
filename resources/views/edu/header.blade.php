                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="/edu/images/all-icon/map.png" alt="icon"><span>Saburai 2, Dei dei, Abuja</span></li>
                                <li><img src="/edu/images/all-icon/email.png" alt="icon"><span>info@dguruboss.com</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="index-2.html">
                                <img width="160px" height="40" src="/edu/images/logo.png" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right ">
                            <div class="support float-left">
                                <div class="icon">
                                    <img src="/edu/images/all-icon/support.png" alt="icon">
                                </div>
                                <div class="cont">
                                    <p>Need Help?</p>
